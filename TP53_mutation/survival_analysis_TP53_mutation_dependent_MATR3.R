...
# regular plot
plot(kmsurvival_mut,lty=2:3, col=3:2, xlab="Time", ylab="Survival Probability", main=toupper("MATR3 (TP53 Mutated)"))
legend(
  "top",
...
# regular plot
plot(kmsurvival_wild,lty=2:3, col=3:2, xlab="Time", ylab="Survival Probability", main=toupper("MATR3 (TP53 Wild Type)"))
legend(
  "topright",

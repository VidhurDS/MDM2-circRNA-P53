...
# regular plot
plot(kmsurvival_wild,lty=2:3, col=2:3, xlab="Time", ylab="Survival Probability", main=toupper("LINC01021 (TP53 Wild Type)"))
legend(
  "topright",
